"""
Gemini API Service for Automated Essay Scoring

This module provides integration with Google's Gemini API for essay scoring and feedback.
"""
...
class GeminiService:
    """Service for interacting with Google's Gemini API for essay scoring"""
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        Args:
            api_key: Gemini API key (optional, can also be set via GEMINI_API_KEY env var)
        """
        ...
        print(f"Available Gemini models: {[m.name for m in self.models]}")
    ...
    def score_essay(self, essay_text: str, prompt: str, rubric: Dict[str, Any], essay_set: int = 1) -> Dict[str, Any]:
        ...
        """
        # Create a system prompt that explains the task to Gemini
        system_prompt = f"""
